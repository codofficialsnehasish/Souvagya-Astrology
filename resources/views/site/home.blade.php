...
@section('content')
            ...
            <div class="row as_verticle_center">
                ...
                <div class="col-lg-6 order-lg-2 col-md-6 order-md-2 col-sm-12 order-sm-2 col-12 order-1">
                    <div class="as_banner_img text-center">
                        <img src="{{ asset('site_asset/images/zodiac.png') }}" alt="" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <form class="needs-validation" action="{{ route('astrologer-booking') }}" method="post" novalidate enctype="multipart/form-data">
            @csrf
            <div class="row justify-content-center">
                <div class="col-md-9">
                    <div class="card mt-4">
                        <div class="card-header text-center">Book Now</div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row" id="client-add">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="emailid" name="emailid" class="form-control" value="{{ old('emailid') }}" placeholder="Enter email" id="emailid">
                                        <div class="valid-feedback">Looks good!</div>
                                ...
                                @endauth
                                <div class="d-md-flex d-grid align-items-center gap-3 justify-content-center">
                            ...
                            <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                                <ul class="as_sign_ul">
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign1.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Aries</h5>
                                                <p>Mar 21 - Apr 19</p>
                                    ...
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign2.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Taurus </h5>
                                                <p>Mar 21 - Apr 19</p>
                                    ...
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign3.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Gemini</h5>
                                                <p>Mar 21 - Apr 19</p>
                                    ...
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign4.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Cancer</h5>
                                                <p>Mar 21 - Apr 19</p>
                                    ...
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign5.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Leo</h5>
                                                <p>Mar 21 - Apr 19</p>
                                    ...
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign6.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Virgo</h5>
                                                <p>Mar 21 - Apr 19</p>
                            ...
                            <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                                <ul class="as_sign_ul as_sign_ul_right">
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign7.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Libra</h5>
                                                <p>Mar 21 - Apr 19</p>
                                    ...
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign8.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Scorpio</h5>
                                                <p>Mar 21 - Apr 19</p>
                                    ...
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign9.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Sagittarius</h5>
                                                <p>Mar 21 - Apr 19</p>
                                    ...
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign10.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Capricorn</h5>
                                                <p>Mar 21 - Apr 19</p>
                                    ...
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign11.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Capricorn</h5>
                                                <p>Mar 21 - Apr 19</p>
                                    ...
                                    <li class="as_sign_box">
                                        <a href="javascript:;">
                                            <span class="as_sign">
                                            <img src="{{ asset('site_asset/images/svg/sign12.svg') }}" alt="">
                                            </span>
                                            <div>
                                                <h5>Pisces</h5>
                                                <p>Mar 21 - Apr 19</p>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="as_product_box">
                                <div class="as_product_img">
                                    ...
                                    <ul>
                                        <li><a href="javascript:;"><img src="assets/images/svg/wishlist.svg" alt=""></a></li>
                                        <li><a href="javascript:;"><img src="assets/images/svg/cart.svg" alt=""><span>Add To Card</span></a></li>
                                        <li><a href="javascript:;"><img src="assets/images/svg/compare.svg" alt=""></a></li>
                                    </ul>
                                </div> 
