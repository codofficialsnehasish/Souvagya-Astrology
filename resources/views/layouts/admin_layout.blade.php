...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard_asset/assets/js/file-uploader/css/jquery.dm-uploader.min.css') }}"/>
    <link rel="stylesheet" href="{{ asset('dashboard_asset/assets/js/file-uploader/css/styles.css') }}"/>
