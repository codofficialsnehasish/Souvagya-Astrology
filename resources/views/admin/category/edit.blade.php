            ...
            <div class="col-md-3">
                <div class="card p-0 mb-3">
                    ...
                    <div class="card-body p-24">
                        <div class="mb-3">
                            <img class="img-thumbnail rounded me-2" id="blah" alt="" width="200" src="{{ $category->getFirstMediaUrl('category') }}" data-holder-rendered="true" style="display: {{ is_have_image($category->getFirstMediaUrl('category')) }};">
                        </div>
                        <div class="mb-0">
