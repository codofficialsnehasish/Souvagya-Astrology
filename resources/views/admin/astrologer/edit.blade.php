            ...
            <div class="main-content">
                ...
                <form class="needs-validation" action="{{ route('astrologer.update',$astrologer->id) }}" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card mt-4">
                                <div class="card-header text-center">Edit Astrologer Details</div>
                                <div class="card-body">
                                    <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="mb-3">
                                                <img class="img-thumbnail rounded me-2" id="pan_card_blah" alt="" width="200" src="{{ asset($astrologer->pan_card_proof) }}" data-holder-rendered="true" style="display: {{ is_have_image($astrologer->pan_card_proof) }};">
                                            </div>
                                            <div class="mb-0">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <table width="100%" cellpadding="5" cellspacing="5" id="table_repeter">
                                            ...
                                            <tr>
                                                <td>
                                                    <input value="{{ $certificate->certificate_name }}" id="certificate_name" class="form-control"/>
                                                </td>
                                                <td>
                                                    <input value="{{ $certificate->certified_date }}" id="certificate_date" class="form-control"/>
                                                </td>
                                                <td>
                                                    <img class="img-thumbnail rounded me-2" id="blah" alt="" width="200" src="{{ asset($certificate->certificate_image) }}" data-holder-rendered="true">
                                                </td>
                                                <td>
                                                    <a href="{{ route('astrologers.delete-certificate-image',$certificate->id) }}" class="btn btn-danger btn-sm"><i class="fadeIn animated bx bx-trash"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            <tr>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="card mt-4">
                                    <div class="card-header text-center">Edit Astrologer Image</div>
                                    <div class="card-body">
                                        <div class="mb-3">
