                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            <label class="form-label" for="booking-date">Booking Date</label>
                                            <input type="text" class="form-control date-time" placeholder="Pick a Booking Date" name="booking_date" value="{{ \Carbon\Carbon::parse($booking->booking_date . ' ' . $booking->start_time)->format('Y-m-d H:i:s') }}" id="booking-date" required>
                                            <div class="valid-feedback">Looks good!</div>
                                            <div class="invalid-feedback">Please pick a date.</div>
                                        </div>
                                        <div class="mb-3 col-md-2">
                                            <label class="form-label" for="end-time">End Time</label>
                                            <input type="time" class="form-control" id="end-time" name="end_time" value="{{ $booking->end_time }}" required>
                                            <div class="valid-feedback">Looks good!</div>
                                            <div class="invalid-feedback">Please pick a date.</div>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                        ...
                                        <div class="mb-3 col-md-6" id="client-choose" style="display: block">
                                            <label for="single-select-field" class="form-label">Client Name and Phone</label>
                                            <select class="form-select" id="single-select-field" data-placeholder="Choose one client" name="client_id" required>
                                                ...
                                                <option value="{{ $client->id }}" @if($booking->user_id == $client->id) selected @endif>{{ $client->name }} | {{ $client->phone }}</option>
                                                @endforeach
                                            </select>
                                        </div>
