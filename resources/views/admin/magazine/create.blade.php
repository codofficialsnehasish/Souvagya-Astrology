    ...
    @section('content')
        ...
        <main class="main-wrapper">
            <div class="main-content">
                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add New Magazine</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <form class="needs-validation" action="{{ route('magazines.store') }}" method="post" novalidate enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card mt-4">
                                <div class="card-header text-center">Add Magazine Details</div>
                                <div class="card-body">
                                    <div class="mb-3">
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="card mt-4">
                                    <div class="card-header text-center">Add Magazines Image</div>
                                    <div class="card-body">
                                        <div class="mb-3">
